        ...
        <div className={styles.cartContent}>
          {cartItems.length === 0 ? (
            <div className={styles.emptyCart}>
              ...
              <h4 className={styles.emptyTitle}>Carrinho vazio</h4>
              <p className={styles.emptyText}>Adicione produtos</p>
              <button 
                    ...
                    <div key={itemKey} className={styles.cartItem}>
                      ...
                      <div className={styles.itemDetails}>
                        ...
                        <div className={styles.itemVariants}>
                          <span className={styles.variant}>{item.size || 'N/A'}</span>
                          <span className={styles.variant}>{item.color || 'N/A'}</span>
                        </div>
